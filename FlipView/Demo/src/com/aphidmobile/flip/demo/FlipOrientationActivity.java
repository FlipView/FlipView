...
public class FlipOrientationActivity extends Activity {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    flipView.setOnViewFlipListener(new ViewFlipListener() {
		...
		public void onViewFlipped(final FlipViewController mFlipViewController,
			...
			if(mFlipViewController.getOrientation()==FlipViewController.HORIZONTAL){
				mFlipViewController.setOrientation(FlipViewController.VERTICAL);
			}else{
				mFlipViewController.setOrientation(FlipViewController.HORIZONTAL);
			}
