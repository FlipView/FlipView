...
public class FlipCycleActivity extends Activity {
...
//					flipView.onAutoEvent(seed%2==0);//mFlipViewController.getOrientation()==FlipViewController.HORIZONTAL);
//					flipView.setSelection(0);
    ...
    flipView.setAdapter(new BaseAdapter() {
      ...
      List<NumberButton> datas=new ArrayList<NumberButton>();
      @Override
